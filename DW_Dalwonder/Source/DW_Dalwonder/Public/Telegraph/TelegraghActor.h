...
public:
	...
	// 사전 경고를 표기할 텔레그래프 나이아가라 시스템 에셋입니다.
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Niagara|Class", meta = (EditCondition = "bUseTelegraph", EditConditionHides))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Niagara", meta = (EditCondition = "bUseTelegraph", EditConditionHides))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Niagara|DOT", meta = (EditCondition = "bIsDOT", EditConditionHides))
	float DOTInterval;
